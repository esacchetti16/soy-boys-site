export default function Footer() {
  return (
    <footer style={{padding:24,marginTop:36,background:'#fff',position:'relative',zIndex:1, boxShadow:'0 -2px 12px rgba(0,0,0,0.07)', width:'100vw'}}>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',width:'100%',paddingLeft:32,paddingRight:32}}>
        <div style={{fontSize:16}}>&copy; 2026 Soy Boys</div>
        ...
        <div style={{fontSize:16}}>Contact: admin@sous-tech.com</div>
      </div>
